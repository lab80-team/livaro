...
## Next
- [ ] **Codex kapısını düzelt: şu anda hiçbir merge'ü durdurmuyor** — kanca muafiyeti (`codexgate.skip`) OTURUMUN klasörüne göre kontrol ediyor; tüm oturumlar vault'ta ve vault muaf olduğu için kod reposuna yapılan push da kapıyı hiç çalıştırmadan geçiyor. Kontrol, push edilen repoya bağlanmalı — area:: engineering · source:: [[2026-08-05 Build Oturumu — Admin Paneli Dilim 1]]
- [ ] **`POST /products/:id/images` kategori fotoğraf kuralını uygulamıyor** (Codex bulgusu, 2026-08-06): eski tekil yükleme ucu hem satıcıya hem admin'e açık ve `assertPhotosUsableForCategory` çalıştırmıyor; `findManagedOrThrow` kategori/ölçüleri seçmediği için guard argümanları da elde değil. Kural 5 Ağustos'ta eklendi ama bu yol atlanmış — dilim 1'e ait DEĞİL, main'de zaten açık — area:: engineering · source:: [[2026-08-05 Build Oturumu — Admin Paneli Dilim 1]]
- [ ] **Edge function'ın mevcut halini yayınla** (24 Tem'den beri güncellenmemiş, 6 değişiklik bekliyor: katalog filtresi, KVKK alanları, güvenlik düzeltmeleri) — **kurucu onayı gerekir**, admin Görev 10'un ön şartı — area:: engineering · source:: [[2026-08-05 Build Oturumu — Admin Paneli Dilim 1]]
- [ ] **Ürün görüntüleme olayını edge function'a ekle + yayınla** — [[2026-08-05 Ürün görüntüleme olayı saatte bir kez sayılır|saatte bir kez sayma]] şartıyla; **kurucu onayı gerekir** — area:: engineering · source:: [[2026-08-05 Build Oturumu — Admin Paneli Dilim 1]]
- [ ] **Güvenli 3D yenileme** (ayrı dilim): yeni model ayrı adrese üretilsin, eski model hazır olana kadar yayında kalsın, üretim patlarsa ürün yayında kalsın — beş şart karar notunda — area:: engineering · source:: [[2026-08-05 3D yenileme dilim 1'den çıkarıldı — veri kaybı riski]]
- [ ] **Admin v1 dilim 2-3-4** (ana sayfa kuyruğu; mağazalar + ürünler sekmeleri + yayından kaldırma; panelden yetkili ekleme) — sırası pilot-öncesi önceliklere göre kararlaştırılacak — area:: engineering · source:: [[Admin Panel]]
