...
## Şu An Bilinenler
- **3D bekleme deneyimi ve stok göstergesi tasarlandı ve KODLANDI (2026-08-05)** → [[2026 08 05 Thinking Session — Mağaza Paneli 3D İlerleme ve Stok Göstergesi]]. **Kod `feature/store-panel-3d-progress` branch'inde (6 commit, 431 test yeşil), Codex incelemesi + merge bekliyor; canlı demo yerelde yapıldı.** Uygulamada verilen iki küçük ek karar: (1) yüzde %100'e varınca kutucukta "Son hazırlıklar yapılıyor" yazar (Open Questions'taki %100 sorusunun pratik cevabı — kurucu isterse değişir); (2) süre ortalaması kategori bazında sayılır (20+ başarılı ölçüm o kategoride birikince). Ayrıca canlıda bulunan tutarsızlık: panel halı kalınlığına 0,1 cm izin veriyor ama sunucu 1 cm altını reddediyor — ayrı iş olarak işaretlendi.
