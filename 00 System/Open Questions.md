...
- **Halı 3D turundan kalan açıklar (2026-08-05/06)** → [[2026-08-06 Halı Doku Delikleri, Saçak Modeli ve Migration Kurtarması]]:
  - **Eğik çekimde saçak ayrımı yapılmıyor** — perspektif düzeltme yolunda halının köşeleri saçak uçlarından ölçüldüğü için gövde sınırı güvenilir değil; saçak ürünün ölçüsünün içine sayılır. Gerileme değil (eskiden hiç yoktu) ve dik tepeden çekim şart koşuluyor. Ayrı bir tur gerekir mi, yoksa "dik çekim şartı" yeterli mi — **To Be Decided**.
  - **Birebir-kırpım istisnası halının İÇİNE kırpılmış fotoğrafı da kabul edebilir** — bordürü kesilmiş bir görsel de aynı oranı koruyabilir. Renkle ayırt edilemiyor; gevşek kural kararının bilinçli bedeli. Gerçek satıcı fotoğrafları geldikten sonra ölçülmeli.
  - **Halı 3D'si gerçek cihazda AR'da hiç doğrulanmadı** — ölçüm ve sentetik testler yeşil, gözle görülmedi.
