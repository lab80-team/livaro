...
- İlk ürünün (MVP) ne olacağı, ilk kullanıcılar, ticari model hâlâ **To Be Decided** — bkz. [[Open Questions]].
- Katalog: yalnızca 3 usdz'li test ürünü (gerçek katalog doldurulmadı — öncelikli iş).
